...
namespace Shit
{
	...
	public:
		struct ColorAttachment
		{
			GLenum attachPoint;
			GLuint writeMask{15};
			GLenum objectType;				 //GL_NONE, GL_FRAMEBUFFER_DEFAULT, GL_TEXTURE, or GL_RENDERBUFFER
		...
		struct FBOState
		{
			GLuint handle{}; //when handle is 0, color and depthstencil attachments are none
