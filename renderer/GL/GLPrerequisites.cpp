...
namespace Shit
{
	...
	namespace GL
	{
		...
		void querySupportedShaderBinaryFormat(std::vector<GLint> &shaderBinaryFormats)
		{
			...
			for (auto &&e : shaderBinaryFormats)
				ST_LOG(e);
#endif
		}
		...
		void querySupportedProgramBinaryFormat(std::vector<GLint> &programBinaryFormats)
		{
			...
			for (auto &&e : programBinaryFormats)
				ST_LOG(e);
#endif
		}
		...
		void listGLInfo()
		{
			...
			for (int i = 0; i < numShadingLanguageVersions; ++i)
				ST_LOG_VAR(glGetStringi(GL_SHADING_LANGUAGE_VERSION, i));
	...
	constexpr GLenum glFormatArray[]{
		...
		GL_R8,										  //R8_UNORM,									// = 9,
		GL_R8_SNORM,								  //R8_SNORM,									// = 10,
		GL_NONE,									  //R8_USCALED,									// = 11,
		GL_NONE,									  //R8_SSCALED,									// = 12,
		GL_R8UI,									  //R8_UINT,									// = 13,
		GL_R8I,										  //R8_SINT,									// = 14,
		GL_SR8_EXT,									  //R8_SRGB,									// = 15,
		GL_RG8,										  //R8G8_UNORM,									// = 16,
		GL_RG8_SNORM,								  //R8G8_SNORM,									// = 17,
		GL_NONE,									  //R8G8_USCALED,								// = 18,
		GL_NONE,									  //R8G8_SSCALED,								// = 19,
		GL_RG8UI,									  //R8G8_UINT,									// = 20,
		GL_RG8I,									  //R8G8_SINT,									// = 21,
		GL_SRG8_EXT,								  //R8G8_SRGB,									// = 22,
		GL_RGB8,									  //R8G8B8_UNORM,								// = 23,
		GL_RGB8_SNORM,								  //R8G8B8_SNORM,								// = 24,
		GL_NONE,									  //R8G8B8_USCALED,								// = 25,
		GL_NONE,									  //R8G8B8_SSCALED,								// = 26,
		GL_RGB8UI,									  //R8G8B8_UINT,								// = 27,
		GL_RGB8I,									  //R8G8B8_SINT,								// = 28,
		GL_SRGB8,									  //R8G8B8_SRGB,								// = 29,
		GL_BGR,										  //B8G8R8_UNORM,								// = 30,
		GL_NONE,									  //B8G8R8_SNORM,								// = 31,
		GL_NONE,									  //B8G8R8_USCALED,								// = 32,
		GL_NONE,									  //B8G8R8_SSCALED,								// = 33,
		GL_NONE,									  //B8G8R8_UINT,								// = 34,
		GL_BGR_INTEGER,								  //B8G8R8_SINT,								// = 35,
		GL_NONE,									  //B8G8R8_SRGB,								// = 36,
		GL_RGBA8,									  //R8G8B8A8_UNORM,								// = 37,
		GL_RGBA8_SNORM,								  //R8G8B8A8_SNORM,								// = 38,
		GL_NONE,									  //R8G8B8A8_USCALED,							// = 39,
		GL_NONE,									  //R8G8B8A8_SSCALED,							// = 40,
		GL_RGBA8UI,									  //R8G8B8A8_UINT,								// = 41,
		GL_RGBA8I,									  //R8G8B8A8_SINT,								// = 42,
		GL_SRGB8_ALPHA8,							  //R8G8B8A8_SRGB,								// = 43,
		GL_BGRA8_EXT,								  //B8G8R8A8_UNORM,								// = 44,
		GL_NONE,									  //B8G8R8A8_SNORM,								// = 45,
		GL_NONE,									  //B8G8R8A8_USCALED,							// = 46,
		GL_NONE,									  //B8G8R8A8_SSCALED,							// = 47,
		GL_NONE,									  //B8G8R8A8_UINT,								// = 48,
		GL_BGRA_INTEGER,							  //B8G8R8A8_SINT,								// = 49,
		GL_NONE,									  //B8G8R8A8_SRGB,								// = 50,
		GL_NONE,									  //A8B8G8R8_UNORM_PACK32,						// = 51,
		GL_NONE,									  //A8B8G8R8_SNORM_PACK32,						// = 52,
		GL_NONE,									  //A8B8G8R8_USCALED_PACK32,					// = 53,
		GL_NONE,									  //A8B8G8R8_SSCALED_PACK32,					// = 54,
		GL_NONE,									  //A8B8G8R8_UINT_PACK32,						// = 55,
		GL_NONE,									  //A8B8G8R8_SINT_PACK32,						// = 56,
		GL_NONE,									  //A8B8G8R8_SRGB_PACK32,						// = 57,
		GL_RGB10_A2,								  //A2R10G10B10_UNORM_PACK32,					// = 58,
		GL_NONE,									  //A2R10G10B10_SNORM_PACK32,					// = 59,
		GL_NONE,									  //A2R10G10B10_USCALED_PACK32,					// = 60,
		GL_NONE,									  //A2R10G10B10_SSCALED_PACK32,					// = 61,
		GL_RGB10_A2UI,								  //A2R10G10B10_UINT_PACK32,					// = 62,
		GL_NONE,									  //A2R10G10B10_SINT_PACK32,					// = 63,
		GL_RGB10_A2,								  //A2B10G10R10_UNORM_PACK32,					// = 64,
		GL_NONE,									  //A2B10G10R10_SNORM_PACK32,					// = 65,
		GL_NONE,									  //A2B10G10R10_USCALED_PACK32,					// = 66,
		GL_NONE,									  //A2B10G10R10_SSCALED_PACK32,					// = 67,
		GL_NONE,									  //A2B10G10R10_UINT_PACK32,					// = 68,
		GL_RGB10_A2UI,								  //A2B10G10R10_SINT_PACK32,					// = 69,
		GL_R16,										  //R16_UNORM,									// = 70,
		GL_R16_SNORM,								  //R16_SNORM,									// = 71,
		GL_NONE,									  //R16_USCALED,								// = 72,
		GL_NONE,									  //R16_SSCALED,								// = 73,
		GL_R16UI,									  //R16_UINT,									// = 74,
		GL_R16I,									  //R16_SINT,									// = 75,
		GL_R16F,									  //R16_SFLOAT,									// = 76,
		GL_RG16,									  //R16G16_UNORM,								// = 77,
		GL_RG16_SNORM,								  //R16G16_SNORM,								// = 78,
		GL_NONE,									  //R16G16_USCALED,								// = 79,
		GL_NONE,									  //R16G16_SSCALED,								// = 80,
		GL_RG16UI,									  //R16G16_UINT,								// = 81,
		GL_RG16I,									  //R16G16_SINT,								// = 82,
		GL_RG16F,									  //R16G16_SFLOAT,								// = 83,
		GL_RGB16,									  //R16G16B16_UNORM,							// = 84,
		GL_RGB16_SNORM,								  //R16G16B16_SNORM,							// = 85,
		GL_NONE,									  //R16G16B16_USCALED,							// = 86,
		GL_NONE,									  //R16G16B16_SSCALED,							// = 87,
		GL_RGB16UI,									  //R16G16B16_UINT,								// = 88,
		GL_RGB16I,									  //R16G16B16_SINT,								// = 89,
		GL_RGB16F,									  //R16G16B16_SFLOAT,							// = 90,
		GL_RGBA16,									  //R16G16B16A16_UNORM,							// = 91,
		GL_RGBA16_SNORM,							  //R16G16B16A16_SNORM,							// = 92,
		GL_NONE,									  //R16G16B16A16_USCALED,						// = 93,
		GL_NONE,									  //R16G16B16A16_SSCALED,						// = 94,
		GL_RGBA16UI,								  //R16G16B16A16_UINT,							// = 95,
		GL_RGBA16I,									  //R16G16B16A16_SINT,							// = 96,
		GL_RGBA16F,									  //R16G16B16A16_SFLOAT,						// = 97,
		GL_R32UI,									  //R32_UINT,									// = 98,
		GL_R32I,									  //R32_SINT,									// = 99,
		GL_R32F,									  //R32_SFLOAT,									// = 100,
		GL_RG32UI,									  //R32G32_UINT,								// = 101,
		GL_RG32I,									  //R32G32_SINT,								// = 102,
		GL_RG32F,									  //R32G32_SFLOAT,								// = 103,
		...
		GL_RGBA32F,									  //R32G32B32A32_SFLOAT,						// = 109,
		GL_NONE,									  //R64_UINT,									// = 110,
		GL_NONE,									  //R64_SINT,									// = 111,
		GL_NONE,									  //R64_SFLOAT,									// = 112,
		GL_NONE,									  //R64G64_UINT,								// = 113,
		GL_NONE,									  //R64G64_SINT,								// = 114,
		GL_NONE,									  //R64G64_SFLOAT,								// = 115,
		GL_NONE,									  //R64G64B64_UINT,								// = 116,
		GL_NONE,									  //R64G64B64_SINT,								// = 117,
		GL_NONE,									  //R64G64B64_SFLOAT,							// = 118,
		GL_NONE,									  //R64G64B64A64_UINT,							// = 119,
		GL_NONE,									  //R64G64B64A64_SINT,							// = 120,
		GL_NONE,									  //R64G64B64A64_SFLOAT,						// = 121,
		GL_NONE,									  //B10G11R11_UFLOAT_PACK32,					// = 122,
		GL_NONE,									  //E5B9G9R9_UFLOAT_PACK32,						// = 123,
		GL_DEPTH_COMPONENT16,						  //D16_UNORM,									// = 124,
		GL_DEPTH_COMPONENT24,						  //X8_D24_UNORM_PACK32,						// = 125,
		GL_DEPTH_COMPONENT32F,						  //D32_SFLOAT,									// = 126,
		GL_STENCIL_INDEX8,							  //S8_UINT,									// = 127,
		GL_NONE,									  //D16_UNORM_S8_UINT,							// = 128,
		GL_DEPTH24_STENCIL8,						  //D24_UNORM_S8_UINT,							// = 129,
		...
		GL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM,		  //BC7_SRGB_BLOCK,								// = 146,
		GL_COMPRESSED_RGB8_ETC2,					  //ETC2_R8G8B8_UNORM_BLOCK,					// = 147,
		GL_COMPRESSED_SRGB8_ETC2,					  //ETC2_R8G8B8_SRGB_BLOCK,						// = 148,
		GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2,  //ETC2_R8G8B8A1_UNORM_BLOCK,					// = 149,
		GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2, //ETC2_R8G8B8A1_SRGB_BLOCK,					// = 150,
		GL_COMPRESSED_RGBA8_ETC2_EAC,				  //ETC2_R8G8B8A8_UNORM_BLOCK,					// = 151,
		GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC,		  //ETC2_R8G8B8A8_SRGB_BLOCK,					// = 152,
		GL_COMPRESSED_R11_EAC,						  //EAC_R11_UNORM_BLOCK,						// = 153,
		GL_COMPRESSED_SIGNED_R11_EAC,				  //EAC_R11_SNORM_BLOCK,						// = 154,
		GL_COMPRESSED_RG11_EAC,						  //EAC_R11G11_UNORM_BLOCK,						// = 155,
		GL_COMPRESSED_SIGNED_RG11_EAC,				  //EAC_R11G11_SNORM_BLOCK,						// = 156,
		...
		GL_NONE,									  //ASTC_10x10_UNORM_BLOCK,						// = 179,
		GL_NONE,									  //ASTC_10x10_SRGB_BLOCK,						// = 180,
		GL_NONE,									  //ASTC_12x10_UNORM_BLOCK,						// = 181,
		GL_NONE,									  //ASTC_12x10_SRGB_BLOCK,						// = 182,
		GL_NONE,									  //ASTC_12x12_UNORM_BLOCK,						// = 183,
		GL_NONE,									  //ASTC_12x12_SRGB_BLOCK,						// = 184,
		GL_NONE,									  //G8B8G8R8_422_UNORM,							// = 1000156000,
		GL_NONE,									  //B8G8R8G8_422_UNORM,							// = 1000156001,
		GL_NONE,									  //G8_B8_R8_3PLANE_420_UNORM,					// = 1000156002,
		GL_NONE,									  //G8_B8R8_2PLANE_420_UNORM,					// = 1000156003,
		GL_NONE,									  //G8_B8_R8_3PLANE_422_UNORM,					// = 1000156004,
		GL_NONE,									  //G8_B8R8_2PLANE_422_UNORM,					// = 1000156005,
		GL_NONE,									  //G8_B8_R8_3PLANE_444_UNORM,					// = 1000156006,
		GL_NONE,									  //R10X6_UNORM_PACK16,							// = 1000156007,
		GL_NONE,									  //R10X6G10X6_UNORM_2PACK16,					// = 1000156008,
		GL_NONE,									  //R10X6G10X6B10X6A10X6_UNORM_4PACK16,			// = 1000156009,
		GL_NONE,									  //G10X6B10X6G10X6R10X6_422_UNORM_4PACK16,		// = 1000156010,
		GL_NONE,									  //B10X6G10X6R10X6G10X6_422_UNORM_4PACK16,		// = 1000156011,
		GL_NONE,									  //G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16, // = 1000156012,
		GL_NONE,									  //G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16,	// = 1000156013,
		GL_NONE,									  //G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16, // = 1000156014,
		GL_NONE,									  //G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16,	// = 1000156015,
		GL_NONE,									  //G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16, // = 1000156016,
		GL_NONE,									  //R12X4_UNORM_PACK16,							// = 1000156017,
		GL_NONE,									  //R12X4G12X4_UNORM_2PACK16,					// = 1000156018,
		GL_NONE,									  //R12X4G12X4B12X4A12X4_UNORM_4PACK16,			// = 1000156019,
		GL_NONE,									  //G12X4B12X4G12X4R12X4_422_UNORM_4PACK16,		// = 1000156020,
		GL_NONE,									  //B12X4G12X4R12X4G12X4_422_UNORM_4PACK16,		// = 1000156021,
		GL_NONE,									  //G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16, // = 1000156022,
		GL_NONE,									  //G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16,	// = 1000156023,
		GL_NONE,									  //G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16, // = 1000156024,
		GL_NONE,									  //G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16,	// = 1000156025,
		GL_NONE,									  //G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16, // = 1000156026,
		GL_NONE,									  //G16B16G16R16_422_UNORM,						// = 1000156027,
		GL_NONE,									  //B16G16R16G16_422_UNORM,						// = 1000156028,
		GL_NONE,									  //G16_B16_R16_3PLANE_420_UNORM,				// = 1000156029,
		GL_NONE,									  //G16_B16R16_2PLANE_420_UNORM,				// = 1000156030,
		GL_NONE,									  //G16_B16_R16_3PLANE_422_UNORM,				// = 1000156031,
		GL_NONE,									  //G16_B16R16_2PLANE_422_UNORM,				// = 1000156032,
		GL_NONE,									  //G16_B16_R16_3PLANE_444_UNORM,				// = 1000156033,
		GL_NONE,									  //PVRTC1_2BPP_UNORM_BLOCK_IMG,				// = 1000054000,
		GL_NONE,									  //PVRTC1_4BPP_UNORM_BLOCK_IMG,				// = 1000054001,
		GL_NONE,									  //PVRTC2_2BPP_UNORM_BLOCK_IMG,				// = 1000054002,
		GL_NONE,									  //PVRTC2_4BPP_UNORM_BLOCK_IMG,				// = 1000054003,
		...
		GL_NONE,									  //ASTC_4x4_SFLOAT_BLOCK_EXT,					// = 1000066000,
		GL_NONE,									  //ASTC_5x4_SFLOAT_BLOCK_EXT,					// = 1000066001,
		GL_NONE,									  //ASTC_5x5_SFLOAT_BLOCK_EXT,					// = 1000066002,
		GL_NONE,									  //ASTC_6x5_SFLOAT_BLOCK_EXT,					// = 1000066003,
		GL_NONE,									  //ASTC_6x6_SFLOAT_BLOCK_EXT,					// = 1000066004,
		GL_NONE,									  //ASTC_8x5_SFLOAT_BLOCK_EXT,					// = 1000066005,
		GL_NONE,									  //ASTC_8x6_SFLOAT_BLOCK_EXT,					// = 1000066006,
		GL_NONE,									  //ASTC_8x8_SFLOAT_BLOCK_EXT,					// = 1000066007,
		...
		GL_NONE,									  //ASTC_10x10_SFLOAT_BLOCK_EXT,				// = 1000066011,
		GL_NONE,									  //ASTC_12x10_SFLOAT_BLOCK_EXT,				// = 1000066012,
		GL_NONE,									  //ASTC_12x12_SFLOAT_BLOCK_EXT,				// = 1000066013,
		GL_NONE,									  //A4R4G4B4_UNORM_PACK16_EXT,					// = 1000340000,
		GL_NONE,									  //A4B4G4R4_UNORM_PACK16_EXT,					// = 1000340001,
	};
	...
	GLenum MapInternalFormat(Format format)
	{
		...
		if (ret == GL_NONE)
			ST_THROW("failed to find corresponding GL fomat", (int)format);
		return ret;
	}
