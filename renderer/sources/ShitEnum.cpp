...
namespace Shit
{
	...
	static FormatAttribute formatAttributeArray[]{
		...
		{"R4G4B4A4_UNORM_PACK16", FormatNumeric::UNORM, BaseFormat::RGBA, 4, 4, 4, 4},				 // = 2,
		{"B4G4R4A4_UNORM_PACK16", FormatNumeric::UNORM, BaseFormat::BGRA, 4, 4, 4, 4},				 // = 3,
		{"R5G6B5_UNORM_PACK16", FormatNumeric::UNORM, BaseFormat::RGB, 5, 6, 5},					 // = 4,
		{"B5G6R5_UNORM_PACK16", FormatNumeric::UNORM, BaseFormat::BGR, 5, 6, 5},					 // = 5,
		{"R5G5B5A1_UNORM_PACK16", FormatNumeric::UNORM, BaseFormat::RGBA, 5, 5, 5, 1},				 // = 6,
		{"B5G5R5A1_UNORM_PACK16", FormatNumeric::UNORM, BaseFormat::BGRA, 5, 5, 5, 1},				 // = 7,
		{"A1R5G5B5_UNORM_PACK16", FormatNumeric::UNORM, BaseFormat::BGRA, 5, 5, 5, 1},				 // = 8,
		...
		{"R8G8B8_USCALED", FormatNumeric::USCALED, BaseFormat::RGB, 8, 8, 8},						 // = 25,
		{"R8G8B8_SSCALED", FormatNumeric::SSCALED, BaseFormat::RGB, 8, 8, 8},						 // = 26,
		...
		{"B8G8R8_USCALED", FormatNumeric::USCALED, BaseFormat::BGR, 8, 8, 8},						 // = 32,
		{"B8G8R8_SSCALED", FormatNumeric::SSCALED, BaseFormat::BGR, 8, 8, 8},						 // = 33,
		...
		{"R8G8B8A8_UNORM", FormatNumeric::UNORM, BaseFormat::RGBA, 8, 8, 8, 8},						 // = 37,
		{"R8G8B8A8_SNORM", FormatNumeric::SNORM, BaseFormat::RGBA, 8, 8, 8, 8},						 // = 38,
		{"R8G8B8A8_USCALED", FormatNumeric::USCALED, BaseFormat::RGBA, 8, 8, 8, 8},					 // = 39,
		{"R8G8B8A8_SSCALED", FormatNumeric::SSCALED, BaseFormat::RGBA, 8, 8, 8, 8},					 // = 40,
		{"R8G8B8A8_UINT", FormatNumeric::UINT, BaseFormat::RGBA, 8, 8, 8, 8},						 // = 41,
		{"R8G8B8A8_SINT", FormatNumeric::SINT, BaseFormat::RGBA, 8, 8, 8, 8},						 // = 42,
		{"R8G8B8A8_SRGB", FormatNumeric::SRGB, BaseFormat::RGBA, 8, 8, 8, 8},						 // = 43,
		{"B8G8R8A8_UNORM", FormatNumeric::UNORM, BaseFormat::BGRA, 8, 8, 8, 8},						 // = 44,
		{"B8G8R8A8_SNORM", FormatNumeric::SNORM, BaseFormat::BGRA, 8, 8, 8, 8},						 // = 45,
		{"B8G8R8A8_USCALED", FormatNumeric::USCALED, BaseFormat::BGRA, 8, 8, 8, 8},					 // = 46,
		{"B8G8R8A8_SSCALED", FormatNumeric::SSCALED, BaseFormat::BGRA, 8, 8, 8, 8},					 // = 47,
		{"B8G8R8A8_UINT", FormatNumeric::UINT, BaseFormat::BGRA, 8, 8, 8, 8},						 // = 48,
		{"B8G8R8A8_SINT", FormatNumeric::SINT, BaseFormat::BGRA, 8, 8, 8, 8},						 // = 49,
		{"B8G8R8A8_SRGB", FormatNumeric::SRGB, BaseFormat::BGRA, 8, 8, 8, 8},						 // = 50,
		{"A8B8G8R8_UNORM_PACK32", FormatNumeric::UNORM, BaseFormat::RGBA, 8, 8, 8, 8},				 // = 51,
		{"A8B8G8R8_SNORM_PACK32", FormatNumeric::SNORM, BaseFormat::RGBA, 8, 8, 8, 8},				 // = 52,
		{"A8B8G8R8_USCALED_PACK32", FormatNumeric::USCALED, BaseFormat::RGBA, 8, 8, 8, 8},			 // = 53,
		{"A8B8G8R8_SSCALED_PACK32", FormatNumeric::SSCALED, BaseFormat::RGBA, 8, 8, 8, 8},			 // = 54,
		{"A8B8G8R8_UINT_PACK32", FormatNumeric::UINT, BaseFormat::RGBA, 8, 8, 8, 8},				 // = 55,
		{"A8B8G8R8_SINT_PACK32", FormatNumeric::SINT, BaseFormat::RGBA, 8, 8, 8, 8},				 // = 56,
		{"A8B8G8R8_SRGB_PACK32", FormatNumeric::SRGB, BaseFormat::RGBA, 8, 8, 8, 8},				 // = 57,
		{"A2R10G10B10_UNORM_PACK32", FormatNumeric::UNORM, BaseFormat::RGBA, 10, 10, 10, 2},		 // = 58,
		{"A2R10G10B10_SNORM_PACK32", FormatNumeric::SNORM, BaseFormat::RGBA, 10, 10, 10, 2},		 // = 59,
		{"A2R10G10B10_USCALED_PACK32", FormatNumeric::USCALED, BaseFormat::RGBA, 10, 10, 10, 2},	 // = 60,
		{"A2R10G10B10_SSCALED_PACK32", FormatNumeric::SSCALED, BaseFormat::RGBA, 10, 10, 10, 2},	 // = 61,
		{"A2R10G10B10_UINT_PACK32", FormatNumeric::UINT, BaseFormat::RGBA, 10, 10, 10, 2},			 // = 62,
		{"A2R10G10B10_SINT_PACK32", FormatNumeric::SINT, BaseFormat::RGBA, 10, 10, 10, 2},			 // = 63,
		{"A2B10G10R10_UNORM_PACK32", FormatNumeric::UNORM, BaseFormat::RGBA, 10, 10, 10, 2},		 // = 64,
		{"A2B10G10R10_SNORM_PACK32", FormatNumeric::SNORM, BaseFormat::RGBA, 10, 10, 10, 2},		 // = 65,
		{"A2B10G10R10_USCALED_PACK32", FormatNumeric::USCALED, BaseFormat::RGBA, 10, 10, 10, 2},	 // = 66,
		{"A2B10G10R10_SSCALED_PACK32", FormatNumeric::SSCALED, BaseFormat::RGBA, 10, 10, 10, 2},	 // = 67,
		{"A2B10G10R10_UINT_PACK32", FormatNumeric::UINT, BaseFormat::RGBA, 10, 10, 10, 2},			 // = 68,
		{"A2B10G10R10_SINT_PACK32", FormatNumeric::SINT, BaseFormat::RGBA, 10, 10, 10, 2},			 // = 69,
		...
		{"R16G16_USCALED", FormatNumeric::USCALED, BaseFormat::RG, 16, 16},							 // = 79,
		{"R16G16_SSCALED", FormatNumeric::SSCALED, BaseFormat::RG, 16, 16},							 // = 80,
		...
		{"R16G16B16_UNORM", FormatNumeric::UNORM, BaseFormat::RGB, 16, 16, 16},						 // = 84,
		{"R16G16B16_SNORM", FormatNumeric::SNORM, BaseFormat::RGB, 16, 16, 16},						 // = 85,
		{"R16G16B16_USCALED", FormatNumeric::USCALED, BaseFormat::RGB, 16, 16, 16},					 // = 86,
		{"R16G16B16_SSCALED", FormatNumeric::SSCALED, BaseFormat::RGB, 16, 16, 16},					 // = 87,
		{"R16G16B16_UINT", FormatNumeric::UINT, BaseFormat::RGB, 16, 16, 16},						 // = 88,
		{"R16G16B16_SINT", FormatNumeric::SINT, BaseFormat::RGB, 16, 16, 16},						 // = 89,
		{"R16G16B16_SFLOAT", FormatNumeric::SFLOAT, BaseFormat::RGB, 16, 16, 16},					 // = 90,
		{"R16G16B16A16_UNORM", FormatNumeric::UNORM, BaseFormat::RGBA, 16, 16, 16, 16},				 // = 91,
		{"R16G16B16A16_SNORM", FormatNumeric::SNORM, BaseFormat::RGBA, 16, 16, 16, 16},				 // = 92,
		{"R16G16B16A16_USCALED", FormatNumeric::USCALED, BaseFormat::RGBA, 16, 16, 16, 16},			 // = 93,
		{"R16G16B16A16_SSCALED", FormatNumeric::SSCALED, BaseFormat::RGBA, 16, 16, 16, 16},			 // = 94,
		{"R16G16B16A16_UINT", FormatNumeric::UINT, BaseFormat::RGBA, 16, 16, 16, 16},				 // = 95,
		{"R16G16B16A16_SINT", FormatNumeric::SINT, BaseFormat::RGBA, 16, 16, 16, 16},				 // = 96,
		{"R16G16B16A16_SFLOAT", FormatNumeric::SFLOAT, BaseFormat::RGBA, 16, 16, 16, 16},			 // = 97,
		...
		{"R32G32B32_UINT", FormatNumeric::UINT, BaseFormat::RGB, 32, 32, 32},						 // = 104,
		{"R32G32B32_SINT", FormatNumeric::SINT, BaseFormat::RGB, 32, 32, 32},						 // = 105,
		{"R32G32B32_SFLOAT", FormatNumeric::SFLOAT, BaseFormat::RGB, 32, 32, 32},					 // = 106,
		{"R32G32B32A32_UINT", FormatNumeric::UINT, BaseFormat::RGBA, 32, 32, 32, 32},				 // = 107,
		{"R32G32B32A32_SINT", FormatNumeric::SINT, BaseFormat::RGBA, 32, 32, 32, 32},				 // = 108,
		{"R32G32B32A32_SFLOAT", FormatNumeric::SFLOAT, BaseFormat::RGBA, 32, 32, 32, 32},			 // = 109,
		...
		{"R64G64B64_UINT", FormatNumeric::UINT, BaseFormat::RGB, 64, 64, 64},						 // = 116,
		{"R64G64B64_SINT", FormatNumeric::SINT, BaseFormat::RGB, 64, 64, 64},						 // = 117,
		{"R64G64B64_SFLOAT", FormatNumeric::SFLOAT, BaseFormat::RGB, 64, 64, 64},					 // = 118,
		{"R64G64B64A64_UINT", FormatNumeric::UINT, BaseFormat::RGBA, 64, 64, 64, 64},				 // = 119,
		{"R64G64B64A64_SINT", FormatNumeric::SINT, BaseFormat::RGBA, 64, 64, 64, 64},				 // = 120,
		{"R64G64B64A64_SFLOAT", FormatNumeric::SFLOAT, BaseFormat::RGBA, 64, 64, 64, 64},			 // = 121,
		{"B10G11R11_UFLOAT_PACK32", FormatNumeric::UFLOAT},											 // = 122,
		{"E5B9G9R9_UFLOAT_PACK32", FormatNumeric::UFLOAT},											 // = 123,
		{"D16_UNORM", FormatNumeric::UNORM, BaseFormat::DEPTH, 0, 0, 0, 0, 16},						 // = 124,
		{"X8_D24_UNORM_PACK32", FormatNumeric::UNORM, BaseFormat::DEPTH, 0, 0, 0, 0, 24, 0, 8},		 // = 125,
		{"D32_SFLOAT", FormatNumeric::SFLOAT, BaseFormat::DEPTH, 0, 0, 0, 0, 32},					 // = 126,
		{"S8_UINT", FormatNumeric::UINT, BaseFormat::STENCIL, 0, 0, 0, 0, 0, 8},					 // = 127,
		{"D16_UNORM_S8_UINT", FormatNumeric::UNORM, BaseFormat::DEPTH_STENCIL, 0, 0, 0, 0, 16, 8},	 //8 UINT",  // = 128,
		{"D24_UNORM_S8_UINT", FormatNumeric::UNORM, BaseFormat::DEPTH_STENCIL, 0, 0, 0, 0, 24, 8},	 //8 UINT",  // = 129,
		{"D32_SFLOAT_S8_UINT", FormatNumeric::SFLOAT, BaseFormat::DEPTH_STENCIL, 0, 0, 0, 0, 32, 8}, //8 UINT", // = 130,
		...
		{"R10X6G10X6B10X6A10X6_UNORM_4PACK16", FormatNumeric::UNORM},								 // = 1000156009,
		{"G10X6B10X6G10X6R10X6_422_UNORM_4PACK16", FormatNumeric::UNORM},							 // = 1000156010,
		{"B10X6G10X6R10X6G10X6_422_UNORM_4PACK16", FormatNumeric::UNORM},							 // = 1000156011,
		{"G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156012,
		{"G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156013,
		{"G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156014,
		{"G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156015,
		{"G10X6_B10X6_R10X6_3PLANE_444_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156016,
		{"R12X4_UNORM_PACK16", FormatNumeric::UNORM},												 // = 1000156017,
		{"R12X4G12X4_UNORM_2PACK16", FormatNumeric::UNORM},											 // = 1000156018,
		{"R12X4G12X4B12X4A12X4_UNORM_4PACK16", FormatNumeric::UNORM},								 // = 1000156019,
		{"G12X4B12X4G12X4R12X4_422_UNORM_4PACK16", FormatNumeric::UNORM},							 // = 1000156020,
		{"B12X4G12X4R12X4G12X4_422_UNORM_4PACK16", FormatNumeric::UNORM},							 // = 1000156021,
		{"G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156022,
		{"G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156023,
		{"G12X4_B12X4_R12X4_3PLANE_422_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156024,
		{"G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156025,
		{"G12X4_B12X4_R12X4_3PLANE_444_UNORM_3PACK16", FormatNumeric::UNORM},						 // = 1000156026,
	...
	{
		auto &a = formatAttributeArray[static_cast<size_t>(format)];
		return (a.componentSizeR +
				a.componentSizeG +
				a.componentSizeB +
				a.componentSizeA +
				a.componentSizeDepth +
				a.componentSizeStencil +
				a.componentSizeX) /
			   8;
	}
