...
namespace Shit
{
	...
	public:
		...
		virtual void Draw(const DrawIndexedIndirectCommand &info) = 0; //same as drawIndexed
		virtual void DrawIndexed(const DrawIndexedIndirectCommand &info) = 0;

		virtual void DrawIndirect(const DrawIndirectInfo &info) = 0;
		virtual void DrawIndirect(const DrawIndirectCountInfo &info) = 0; //same as drawIndirectCount
		...
		virtual void DrawIndexedIndirect(const DrawIndirectCountInfo &info) = 0; //same as drawIndexedIndirectCount
