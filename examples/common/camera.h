...
class Camera : public Component
{
	...
	std::variant<PerspectiveDescription, OrthogonalDescription> _extraDesc = PerspectiveDescription{glm::radians(60.f), 1.777};
...
public:
	EditCameraController(GameObject *gameobject, Shit::Window *window);
