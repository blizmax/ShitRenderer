...
//	getVertexAttributeDescription(uint32_t startLocation = 0, uint32_t binding = 0)
//	{
//		return std::vector<Shit::VertexAttributeDescription>{
//			{startLocation, binding, Shit::Format::R32G32B32_SFLOAT, offsetof(Vertex, position)},
//			{startLocation + 1, binding, Shit::Format::R32G32B32_SFLOAT, offsetof(Vertex, normal)},
//			{startLocation + 2, binding, Shit::Format::R32G32B32A32_SFLOAT, offsetof(Vertex, tangent)},
//			{startLocation + 3, binding, Shit::Format::R32G32_SFLOAT, offsetof(Vertex, texCoord)},
//			{startLocation + 4, binding, Shit::Format::R32G32B32A32_SFLOAT, offsetof(Vertex, color)},
//			{startLocation + 5, binding, Shit::Format::R32G32B32A32_SFLOAT, offsetof(Vertex, joints)},
//			{startLocation + 6, binding, Shit::Format::R32G32B32A32_SFLOAT, offsetof(Vertex, weights)},
//		};
//	}
//};
