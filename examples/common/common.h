...
Shit::ShadingLanguage chooseShaderShourceLanguage(const std::vector<Shit::ShadingLanguage> &shadingLanguages, Shit::Device *pDevice);

void generateIrradianceMap(
	Shit::Device *pDevice,
	Shit::Image *pSrcImageView2D,
	Shit::ImageLayout srcInitialLayout,
	Shit::ImageLayout srcFinalLayout,
	Shit::Image *pDstImageViewCube,
...
class FilterKernel
{
	...
	static float gaussian(float r, float sigma)
	{
