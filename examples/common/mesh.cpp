...
std::optional<float> intersectTriangle(
	glm::vec3 const &p, glm::vec3 const &dir, glm::vec3 const *pVertices)
{
...
size_t Primitive::getFaceIndexOffset(size_t faceIndex)
{
	return getTopologyFaceStep(topology) * faceIndex;
}
