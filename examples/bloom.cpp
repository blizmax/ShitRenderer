...
public:
	...
	void prepareDisplayDescriptorSet()
	{
		...
		Shit::WriteDescriptorSet writes[]{
			{displayPipelineInfo.descriptorSets[0], 0, 0, 1, Shit::DescriptorType::COMBINED_IMAGE_SAMPLER, &imagesInfo[0]},
	...
	void prepareComputePipeline()
	{
		...
		compPipelineInfo.pipelineLayout = _device->Create(Shit::PipelineLayoutCreateInfo{
	...
	void recordDefaultCommandBuffer() override
	{
		...
		for (int i = 0; i < MAX_FRAMES_IN_FLIGHT; ++i)
		{
			...
			cmdBuffer->GenerateMipmap({inTexture->getImage(), Shit::Filter::LINEAR,
