...
public:
	void preparePipeline()
	{
		Shit::DescriptorSetLayoutBinding binding{
			...
			Shit::ShaderStageFlagBits::VERTEX_BIT | Shit::ShaderStageFlagBits::FRAGMENT_BIT | Shit::ShaderStageFlagBits::GEOMETRY_BIT};
		...
		pipelineInfo.shaders = {
			...
			static_cast<Shader *>(_shaderManager->create(
				buildShaderPath(_device, geomShaderPath, _rendererVersion), ResourceManager::DEFAULT_LOADER_NAME, {{"stage", "GEOM"}})),
			static_cast<Shader *>(_shaderManager->create(
