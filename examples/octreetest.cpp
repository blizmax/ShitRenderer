...
// static auto testModelPath = SHIT_SOURCE_DIR "/assets/models/obj/chinesedragon.obj";
//static auto testModelPath = SHIT_SOURCE_DIR "/assets/models/obj/SheenCloth/SheenCloth.obj";
...
//static auto testModelPath = SHIT_SOURCE_DIR "/assets/models/obj/cornell_box2.obj";
...
public:
	void loadAssets()
	{
		auto model = static_cast<Model *>(
						 _modelManager->create(testModelPath))
	...
	void drawGameObjectPoint(Shit::CommandBuffer *cmdBuffer, GameObject *gameObject, Shit::PipelineLayout *pipelineLayout)
	{
	...
	void drawGameObjectOctree(Shit::CommandBuffer *cmdBuffer, GameObject *gameObject, Shit::PipelineLayout *pipelineLayout)
	{
	...
	void recordDefaultCommandBuffer() override
	{
		...
		for (int i = 0; i < MAX_FRAMES_IN_FLIGHT; ++i)
		{
			...
			cmdBuffer->BindPipeline(Shit::BindPipelineInfo{
				Shit::PipelineBindPoint::GRAPHICS, pipeline});
	...
	void setupImGui()
	{
		...
		const char *mode = items[octreeMode]; // Label to preview before opening the combo (technically it could be anything)
